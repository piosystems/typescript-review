  //npm install @types/node-fetch or npm install node-fetch
...
// npm run build to update index.js in build, and node build/index.js to run the code*/
...
.then(function(myJson:any){
    let perp:any
    perp = myJson*/
let TODO = Object.assign(perp);
 for(var i = 0; i<TODO.length; i++){
   
     TODO[i].title = `This is title with iD number ${TODO[i].id}`
